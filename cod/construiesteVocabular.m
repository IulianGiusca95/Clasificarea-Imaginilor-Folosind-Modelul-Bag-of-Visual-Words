...
%     cuvinteVizuale - matrice k x 128, fiecare linie reprezinta un cuvant vizual (un centru al unui cluster)
  ...
  for i=1:numarImagini
    ...
    [desc,patch]=calculeazaHistogrameGradientiOrientati(img,puncteCaroiaj,dimensiuneCelula);
    descriptoriHOG = [descriptoriHOG;desc];
    patchuri=[patchuri;patch];
  ...
  [cuvinteVizuale,et] = kmeans_iter(descriptoriHOG, k, iterMax);
